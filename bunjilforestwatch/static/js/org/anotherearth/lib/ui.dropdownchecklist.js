    ...
    $.widget("ui.dropdownchecklist", {
        ...
        enable: function() {
            this.controlWrapper.find(".ui-dropdownchecklist").removeClass("ui-dropdownchecklist-disabled");
						this.controlWrapper.find(".ui-dropdownchecklist-item > input[type=checkbox]").removeAttr('disabled');
            this.disabled = false;
        },
        disable: function() {
            this.controlWrapper.find(".ui-dropdownchecklist").addClass("ui-dropdownchecklist-disabled");
						this.controlWrapper.find(".ui-dropdownchecklist-item > input[type=checkbox]").attr('disabled', 'disabled');
            this.disabled = true;
        },
        destroy: function() {
